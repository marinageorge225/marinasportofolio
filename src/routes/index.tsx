  ...
  head: () => ({
    meta: [
      { title: "Marina George — Software Engineer & Full-Stack Developer" },
      {
        name: "description",
        content:
          "AI graduate and full-stack developer based in Alexandria, Egypt. Building modern, user-focused web applications with React, Angular, Next.js and Flutter.",
      },
      { property: "og:title", content: "Marina George — Software Engineer" },
      {
        property: "og:description",
        content: "Portfolio, projects, experience and contact details for Marina George.",
      },
    ],
  }),
  component: Portfolio,
...
const experiences = [
  {
    role: "International Instructor (Freelance)",
    company: "The Knowledge Academy",
    period: "May 2026 – Present",
    bullets: [
      "Deliver training sessions and workshops for international audiences in technology and software development.",
      "Adapt content to diverse learning needs across countries and experience levels.",
    ],
  },
  {
    role: "Instructor (Kids 6–18)",
    company: "iSchool",
    period: "Aug 2025 – Oct 2025",
    bullets: [
      "Delivered 40+ project-based lessons across Flutter, Web Dev, AI and Data Science.",
      "Guided 20+ students per cohort through hands-on coding exercises.",
    ],
  },
  {
    role: "Java & Python Instructor",
    company: "Innova Steam — AAST",
    period: "Jun 2025 – Aug 2025",
    bullets: [
      "Taught Java and Python to 15+ students through hands-on sessions.",
...
const projects = [
  {
    ...
    desc: "Chat app for individuals with hearing impairments. Sign-to-text and text-to-speech, built with Flutter + Firebase.",
    tech: ["Flutter", "Firebase", "AI"],
  },
  {
    name: "Roselle E-Commerce",
    tag: "Full Stack",
    desc: "Feature-rich shopping platform with product listings, cart, orders and social login.",
    tech: ["Angular 21", "TypeScript", "Bootstrap", "Node.js"],
  },
  {
    name: "Social App",
    tag: "Full Stack",
    desc: "Facebook-inspired social media app with news feed, posts and social interactions.",
    tech: ["React", "Tailwind", "Hero UI", "Node.js"],
  },
  {
    name: "Bakery React",
    tag: "Full Stack",
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-40 backdrop-blur-md bg-background/75 border-b border-border/60">
        <nav className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <a href="#top" className="font-display text-xl font-semibold tracking-tight">
            Marina<span className="text-clay">.</span>
          </a>
      ...
      <section id="top" className="relative overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(900px 500px at 80% -10%, var(--accent), transparent 60%), radial-gradient(700px 400px at -10% 10%, var(--sand), transparent 70%)",
          }}
        />
        <div className="max-w-6xl mx-auto px-6 pt-20 pb-28">
          <div className="grid sm:grid-cols-[1fr_auto] gap-8 sm:gap-12 items-center">
            <div>
              <p className="text-sm uppercase tracking-[0.25em] text-clay mb-6">
                Software Engineer · Alexandria, Egypt
              </p>
              <h1 className="font-display text-5xl md:text-6xl lg:text-7xl font-medium leading-[1.05]">
                Hi, I'm Marina — I build <em className="italic text-clay">warm</em>, user-focused
                web experiences.
              </h1>
              <p className="mt-8 text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed">
                Recent Artificial Intelligence graduate from Alexandria University, passionate about
                full-stack development — React, Angular, Next.js, Flutter — and building clean,
                scalable products.
              </p>
            </div>
            <div className="relative justify-self-center sm:justify-self-end order-first sm:order-last">
              ...
              <div className="relative w-40 h-40 sm:w-56 sm:h-56 md:w-72 md:h-72 rounded-full border-4 border-card shadow-2xl overflow-hidden">
                <img src={marinaPhoto} alt="Marina George" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
          <div className="mt-10 flex flex-wrap gap-3">
            <a
              href="#projects"
              className="px-6 py-3 rounded-full bg-primary text-primary-foreground hover:opacity-90 transition inline-flex items-center gap-2"
            >
              View my work <ExternalLink className="w-4 h-4" />
            </a>
            <a
              href={cvAsset.url}
              download="Marina_George_CV.pdf"
              className="px-6 py-3 rounded-full bg-clay text-primary-foreground hover:opacity-90 transition inline-flex items-center gap-2"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="px-6 py-3 rounded-full border border-border bg-card hover:bg-secondary transition inline-flex items-center gap-2"
            >
              <Github className="w-4 h-4" /> GitHub
            </a>
            <a
              href="https://linkedin.com/in/marina-george-b14234234"
              target="_blank"
              rel="noreferrer"
              className="px-6 py-3 rounded-full border border-border bg-card hover:bg-secondary transition inline-flex items-center gap-2"
            >
      ...
      <section id="about" className="max-w-6xl mx-auto px-6 py-24 border-t border-border/60">
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-2 space-y-5 text-lg leading-relaxed text-muted-foreground">
            <p>
              I'm a software engineer with a foundation in Artificial Intelligence and a love for
              crafting modern web applications. I enjoy turning complex problems into clean,
              maintainable solutions — and teaching others along the way.
            </p>
            <p>
              Beyond shipping code, I've taught Flutter, Web Development, AI and Data Science to 35+
              students, and I'm currently expanding into open-source development at ITI.
            </p>
      ...
      <section id="experience" className="max-w-6xl mx-auto px-6 py-24 border-t border-border/60">
        ...
        <div className="space-y-2">
          {experiences.map((e, i) => (
            <div
              key={i}
              className="grid md:grid-cols-[200px_1fr] gap-6 py-8 border-t border-border/60"
            >
                ...
                <ul className="space-y-2 text-muted-foreground">
                  {e.bullets.map((b, j) => (
                    <li key={j} className="flex gap-3">
                      <span className="text-clay mt-2">·</span>
                      <span>{b}</span>
                    </li>
                  ))}
                </ul>
      ...
      <section id="projects" className="max-w-6xl mx-auto px-6 py-24 border-t border-border/60">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {projects.map((p) => (
            <article
              key={p.name}
              className="group rounded-2xl bg-card border border-border p-8 hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
            >
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl bg-card border border-border p-8">
            ...
            <p className="text-clay">
              B.Sc. in Artificial Intelligence — Faculty of Computer and Data Science
            </p>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              ...
              <li>
                · FIRST LEGO League Explore Egypt Championship — Bibliotheca Alexandrina (Feb 2024)
              </li>
            </ul>
          </div>
        </div>
      ...
      <section id="contact" className="border-t border-border/60">
        <div className="max-w-6xl mx-auto px-6 py-28">
          ...
          <h2 className="font-display text-5xl md:text-6xl max-w-3xl leading-tight">
            Let's build something thoughtful together.
          </h2>
          <p className="mt-6 text-lg text-muted-foreground max-w-2xl">
            Open to full-time and freelance opportunities — and open to relocation.
          </p>
          <div className="mt-12 grid sm:grid-cols-2 gap-4 max-w-2xl">
            <a
              href="mailto:marinageorgezarif@gmail.com"
              className="flex items-center gap-3 p-5 rounded-2xl bg-card border border-border hover:bg-secondary transition"
            >
              <Mail className="w-5 h-5 text-clay" />
              <span>marinageorgezarif@gmail.com</span>
            </a>
            <a
              href="tel:+201210400272"
              className="flex items-center gap-3 p-5 rounded-2xl bg-card border border-border hover:bg-secondary transition"
            >
